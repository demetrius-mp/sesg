...
def test_generate_search_string_with_1_similar_word_and_2_topics_and_3_words_per_topic(
    topics_list: list[list[str]],
    enrichment_text: str,
    language_models,
):
    ...
    expected = '(("software" OR "management") AND ("measurement" OR "development") AND ("gqm")) OR (("process" OR "software") AND ("software" OR "management") AND ("strategic" OR ","))'
