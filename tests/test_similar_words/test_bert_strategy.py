...
def test_get_bert_similar_words_should_return_empty_list_when_word_does_not_appear_in_enrichment_text(
    bert_models,
    enrichment_text,
):
    bert_tokenizer, bert_model = bert_models
...
def test_get_bert_similar_words_should_return_empty_list_when_word_has_space(
    bert_models,
    enrichment_text,
):
    bert_tokenizer, bert_model = bert_models
...
def test_bert_similar_words_should_not_have_bert_oov_words(
    bert_similar_words,
):
    assert not any([word.startswith("##") for word in bert_similar_words])


def test_bert_similar_words_should_have_organization_related_words(
    bert_similar_words,
):
    expected_subset = {
        "management",
    ...
    assert expected_subset.issubset(bert_similar_words)
